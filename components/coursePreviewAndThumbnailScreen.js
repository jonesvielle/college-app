...
const CoursePreviewAndThumbnailScreen = ({route, navigation}) => {
  const {
    title,
    description,
    courseObjective,
  ...
  const handleUploadLecture = (f, t) => {
    ...
    var config = {
      method: 'post',
      url: 'https://collageapi.herokuapp.com/api/upload_lecture/',
      headers: {
...
export default CoursePreviewAndThumbnailScreen;
