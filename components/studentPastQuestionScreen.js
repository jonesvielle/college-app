...
const StudentPastQuestionScreen = ({route, navigation}) => {
  const {
    university,
    authenticationToken,
    department,
  ...
  const getData = () => {
    Axios({
      method: 'post',
      url: 'https://collageapi.herokuapp.com/api/get_past_questions_student_full/none',
      headers: {
      ...
      .then(function (response) {
        console.log('dataaaaaaaaa', JSON.stringify(response.data));
...
export default StudentPastQuestionScreen;
